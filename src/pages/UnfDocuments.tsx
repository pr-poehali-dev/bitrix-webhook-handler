      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Интеграция документов с УНФ</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Функционал интеграции с УНФ будет добавлен в ближайшее время</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center justify-center py-12 text-center">
              <Icon name="Construction" size={64} className="text-muted-foreground mb-4" />
              <p className="text-muted-foreground">Здесь будет интеграция документов с УНФ</p>
            </div>
          </CardContent>
        </Card>
      </div>
